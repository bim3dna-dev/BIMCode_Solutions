      ...
      <div className="section-container relative flex flex-col-reverse items-center gap-12 py-20 lg:flex-row lg:gap-16 lg:py-28">
        <div className="flex-1">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.4em] text-brand-500 dark:text-brand-300">
            {t("Revit Automation for BIM Teams")}
          </p>
          ...
          <dl className="mt-10 grid grid-cols-2 gap-6 text-sm text-slate-500 dark:text-slate-400 sm:grid-cols-4">
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
                {t("Revit-native workflows")}
              </dt>
              <dd>{t("Built inside production BIM environments")}</dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
                {t("BIM standards first")}
              </dt>
              <dd>{t("Aligned with templates and delivery rules")}</dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
                {t("Python, Dynamo, pyRevit, Revit API")}
              </dt>
              <dd>{t("Practical tooling for repeatable work")}</dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
                {t("Built for MEP and production teams")}
              </dt>
              <dd>{t("Focused on real documentation workflows")}</dd>
            </div>
          </dl>
        </div>
